...
%plot(metrics_v{1}, (metrics_v{2} - 0.7) * 100 / 2.3, 'm-'); %hold on; % player speed
%plot(metrics_v{1}, (metrics_v{3} - 1 ) * 100 / 3, 'm-'); %hold on; % zombie speed
%plot(metrics_v{1}, (metrics_v{4} - 70) * 100 / 380, 'm-'); %hold on; % fog distant
%----------------------------------------------
xlabel('time');
ylabel('signal');
%grid on;
