...
ManagedProxy^ ManagedProxy::create(const stdtstring &dllName, const stdtstring &managedTypeName, const AnyTypeArray &ctorParams)
{
    ...
    array<Object^>^ params = cliArrayFromAnyArray(ctorParams);
...
Object^ ManagedProxy::invokeFunction(String^ functionName, array<Object^>^ params, BindingFlags bindingFlags)
{
