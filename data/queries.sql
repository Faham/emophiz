...
[imi9] Intrinsic Motivation Inve... | I didn’t try very hard at playing {qJ7p087llp_9}
...
18	I feel like I just can’t stop playing
5	If someone talks to me, I don’t hear them
10	I can’t tell that I’m getting tired
9	I don’t answer when someone talks to me
...
-19	I don’t feel close to other players. (-)
...
select
	...
	avg(pens0) + avg(pens8) + avg(pens16) / 3 as pens_competence,
	avg(pens2) + avg(pens10) + avg(pens18) / 3 as pens_autonomy,
	avg(pens4) - avg(pens19) / 2 as pens_relatedness,
	avg(pens1) + avg(pens3) + avg(pens5) - avg(pens7) + avg(pens9) + avg(pens11) + avg(pens13) + avg(pens15) + avg(pens17) / 9 as pens_presence_immersion,
	avg(pens6) + avg(pens14) + avg(pens20) / 3 as pens_intuitive_controls,

	sum(ceq17) as ceq_immersion,
	sum(ceq0) + sum(ceq16) + sum(ceq12) + sum(ceq1) as ceq_presence,
	sum(ceq15) + sum(ceq14) + sum(ceq11) + sum(ceq6) + sum(ceq4) + sum(ceq18) + sum(ceq5) + sum(ceq10) + sum(ceq9) as ceq_flow,
	sum(ceq8) + sum(ceq7) + sum(ceq2) + sum(ceq13) + sum(ceq3) as ceq_absorption
