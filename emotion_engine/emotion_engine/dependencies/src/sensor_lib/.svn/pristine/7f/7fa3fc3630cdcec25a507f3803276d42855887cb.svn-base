...
class EyetrackerBrowser(gtk.VBox):
    def __init__(self, mainloop):
        ...
        self.browser = tobii.sdk.browsing.EyetrackerBrowser(self.mainloop, 
...
class SyncWatcher(object):
    def __init__(self):
        ...
        self.mainloop = tobii.sdk.mainloop.MainloopThread()
    ...
    def eyetracker_activated(self, treeview, path, user_data=None):
        ...
        tobii.sdk.eyetracker.Eyetracker.create_async(self.mainloop,
                                                     eyetracker_info,
...
if __name__ == "__main__":
    ...
    if 'TOBII_SDK_LOG_LEVEL' not in os.environ:
        os.environ['TOBII_SDK_LOG_LEVEL'] = 'TRACE'    
    tobii.sdk.init()
