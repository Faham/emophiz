...
{
    class GsrSensor : TtlSensor
    {
        public GsrSensor(GsrProcessor processor, String name, Channel channel, float samplesPerSecond, bool queueData) : base(processor, new QueueInput<float>(samplesPerSecond), name, channel, queueData)
        {
            //Preconditions
        ...
        public override SensorType SensorType { get { return SensorType.Gsr; } }
        ...
        readonly GsrProcessor processor;
