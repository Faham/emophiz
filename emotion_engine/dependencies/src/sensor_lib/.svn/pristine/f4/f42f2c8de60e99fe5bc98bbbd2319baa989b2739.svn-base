...
{
    class MuscleSensor : TtlSensor
    {
        public MuscleSensor(MuscleProcessor processor, String name, Channel channel, float samplesPerSecond, bool queueData) : base(processor, new QueueInput<float>(samplesPerSecond), name, channel, queueData)
        {
            //Preconditions
        ...
        public override SensorType SensorType { get { return SensorType.Muscle; } }
        ...
        readonly MuscleProcessor processor;
