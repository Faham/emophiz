...
class EyetrackerBrowser:
    ...
    def __init__(self):
        ...
        self.browser = tobii.sdk.browsing.EyetrackerBrowser(self.mainloop_thread, lambda t, n, i: glib_idle_add(self.on_eyetracker_browser_event, t, n, i))
    ...
    def row_activated(self, treeview, path, user_data=None):
        ...
        eyetracker_info = self.eyetrackers[model.get_value(iter, 0)]
    ...
    def on_eyetracker_created(self, error, eyetracker, eyetracker_info):
        ...
        try:
            ...
            self.eyetracker_label.set_markup("<b>Connected to Eyetracker: %s</b>" % (eyetracker_info))
            print "   --- Connected!"
        except Exception, ex:
    ...
    def on_eyetracker_upgraded(self, error, protocol, eyetracker_info):
        try:
            self.trackstatus.set_eyetracker(self.eyetracker)
            self.calibplot.set_eyetracker(self.eyetracker)
            self.button.set_sensitive(True)
